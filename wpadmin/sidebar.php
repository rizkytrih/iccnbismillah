                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="banner.php" class="waves-effect"><i class="mdi mdi-home-analytics"></i><span>Banner</span></a>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect"><i
                                        class="mdi mdi-diamond-stone"></i><span>Status</span></a>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect"><i
                                        class="mdi mdi-table-merge-cells"></i><span>Event</span></a>
                                <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect"><i
                                        class="mdi mdi-poll"></i><span>Forum</span></a>
                                <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="waves-effect"><i
                                        ...
                                        class="badge badge-pill badge-danger float-right">6</span><span>Artikel</span></a>
                                <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="pages-starter.html">Pengaturan</a></li>
