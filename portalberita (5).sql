...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Bulan Mei 2023 pada 03.39
...
CREATE TABLE `acara` (
  ...
  `detail_acara` varchar(350) NOT NULL,
  `tempat_acara` varchar(15) NOT NULL,
  `tanggal` date NOT NULL,
  `tgl_posting` varchar(30) NOT NULL,
  `jam` varchar(30) DEFAULT NULL,
  `lokasi_peta` varchar(100) DEFAULT NULL,
...
INSERT INTO `acara` (`id`, `gambar_event`, `nama_event`, `detail_acara`, `tempat_acara`, `tanggal`, `tgl_posting`, `jam`, `lokasi_peta`, `alamat`, `id_admin`, `dilihat`) VALUES
(10, 'acara_647237b9a3c3d.jpg', 'Praktik Baik Pembelajaran Berdiferensiasi pada Siswa Kelas VI Sekolah Dasar', '<p>ini adalah proses pembantikan</p>', 'Palkomtek', '0000-00-00', '2023-05-27 19:02:49', '11:00 WIB - 14:00 WIB', '-6.177761, 106.790174', 'Jl siuni', 1, 0);
...
INSERT INTO `admin` (`id_admin`, `username`, `password`, `nama_awal`, `nama_akhir`, `foto`, `deskripsi`, `tempat_lahir`, `tgl_lahir`, `email`, `tempat_tinggal`, `no_hp`, `level`, `tgl_post`, `id_pendidikan`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Fajar', 'Nugraha', 'deadpool.jpg', 'Seorang mahasiswa kupu-kupu di AMIK BSI Tasikmalaya. Hobinya bermain gitar dan bermain game dan tidak jago-jago amat dalam melakukan kedua hal tersebut. Menyukai karakter komik Deadpool karena tingkah-lakunya yang nyeleneh.', 'Palembang', '12/04/2000', 'aldogunawan@gmail.com', 'Palembang', '081368712324', 'admin', '2023-05-01 23:35:23', 1),
(2, 'achmad', '$2y$10$h/h71onUEpr1Q.S4QjGQkuMXP8p6rd1XP0YIlSIbGCDzlzHa57hoS', 'Achmad kusaidi', 'irvandi jamal', 'kylo-ren.png', 'Seorang Penyuka Star Wars', '', '', '', '', '', 'author', '2023-05-02 23:35:23', 0),
(3, 'rizky18', '6b5cf94ec8e1a7df1801cc7ce11781bf', 'rizky', 'tri', '', 'Saya adalah Proplayer kelas', 'Paleembang', '12/04/2000', 'aldogunawan@gmail.com', 'Palembang', '081273256096', 'author', '2023-05-03 23:35:23', 1);
...
(1, 'Slide 1', 'kelassa', 'gambar/banner/641.jpg'),
(2, 'slide 2', 'ini adalah slide 2', 'gambar/banner/667.jpg'),
(3, 'Slide 3', 'ini slide 3', 'gambar/banner/823.jpg'),
(4, 'Slide 4', 'ini slide 4', 'gambar/banner/799.png');
...
(17, 'Laporan Kegiatan 2022 dan Rencana Kegiatan 2023', 3, 'WhatsApp Image 2023-04-21 at 21.52.13.jpg', '<p>aoikak yonh</p>\r\n', '2023-05-26 04:50:58', 1, 0),
(23, 'Jalin Kerja Sama guna Kemajuan Bersama', 3, 'berita_647162d55702e.jpeg', '<p>Telah berlangsung seremonial penandatanganan kerja sama antara Indonesian Career Centre Network (ICCN) dengan Himpunan Psikologi Indonesia (HIMPSI)&nbsp; pada Sabtu (10/4/21). Penandatanganan dilakukan oleh Presiden ICCN, Teddy Indira Budiwan dengan Ketua Umum HIMPSI, Seger Handoyo.</p>\r\n<p>Dilanjutkan dengan diskusi pakar:&nbsp;<em>Peran Pusat Karier sebagai Pendamping Karier</em>&nbsp;<em>Mahasiswa&nbsp;</em>oleh Pengembangan Pusat Karier ICCN, Yanti Rubiyanti Ayang serta&nbsp;<em>Wellbeing and 101 Office Hack&nbsp;</em>oleh Asosiasi Psikolog Industri Organisasi HIMPSI, Arum Etikariena.</p>\r\n<p>Indonesian Career Centre Network (ICCN) menggelar webinar Career Center Officer Program (CCOP) 4.0.&nbsp;<em>series&nbsp;</em>2 pada Sabtu (10/3/21). Kegiatan tersebut dilaksanakan selama dua hari dengan tema&nbsp;<em>Entrepreneurship Masterclass .&nbsp;</em>Dua pemantik diundang untuk memberikan materi&nbsp; CCOP 4.0.</p>\r\n<p>Direktur ITB Career Center, Sonny Rustiadi menjelaskan bahwa&nbsp;<em>design thinking</em>&nbsp;merupakan pola pikir&nbsp;<em>(mindset.&nbsp;</em>Proses yang bermakna, budaya prototipe, menunjukkan jangan memberi tahu, kepedulian sesama, kolaborasi yang bebas, dan aksi yang menular merupakan bentuk pola pikir.</p>\r\n<p>Dosen Departemen Agribisnis Fakultas Ekonomi dan Manajemen Institut Pertanian Bogor (IPB) University, Feryanto membeberkan cara penyusunan rencana bisnis. Diawali ide dan latar belakang yang kuat, tentukan bisnis yang ditawarkan dan target, susun dengan menarik dan ringkas sesuai metode yang umum digunakan.</p>', '2023-05-27 03:54:29', 1, 2),
(24, 'Jalin Kerja Sama guna Kemajuan Bersama', 3, 'berita_647163974709b.jpg', '<p><strong>JAKARTA, KOMPAS.com</strong> - Politisi Partai Demokrasi Indonesia Perjuangan (PDI-P) Adian Napitupulu menyindir politisi Partai Gerindra Andre Rosiade soal peluang Prabowo Subianto dalam pemilihan presiden 2024. Adian menyebut Prabowo&nbsp; bukan lawan sepadan bagi bakal capres dari partainya, Ganjar Pranowo. Dia mengungkit kekalahan berulang kali yang dialami Prabowo pada kontestasi Pilpres. Sindiran Adian ini pun langsung dibalas Andre dengan suara tinggi. Perdebatan sengit terjadi di antara keduanya saat mereka hadir sebagai narasumber dalam rilis survei <a title=\"pole\" href=\"https://nasional.kompas.com/read/2023/04/28/22415431/sindir-prabowo-adian-enggak-asik-tanding-lawan-yang-berkali-kali-kalah\" target=\"_blank\">Poltracking Indonesia pada Jumat </a><strong>(28/4/2023)</strong>&nbsp; \"Bagaimana kita mau takut atau kita khawatir, kalau melawan Prabowo yang berkali-kali kalah. Prabowo belum pernah punya pengalaman menang, pengalamannya kalah terus,\" singgung Adian dalam tayangan YouTube Poltracking TV, Jumat. Baca juga: Prabowo Semringah sampai Joget, Pilih Cak Imin Jadi Cawapres? Ia menganggap kontestasi Pilpres tidak akan berjalan seru jika melawan sosok yang kerap kali kalah. \"Sebenarnya, enggak menyenangkan buat kita bertanding dengan orang yang berkali-kali kalah. Kayaknya gimana gitu, enggak asik begitu loh. Ndre, sorry Ndre hehehe,\" ucap Adian. Andre Rosiade pun menanggapi pernyataan Adian dengan serius. Hal ini terlihat dari nada bicaranya yang agak naik. Andre meyakini, jika orang yang bersifat angkuh bakal mengalami kekalahan di kemudian hari. Baca juga: Survei Poltracking: Elektabilitas Prabowo Teratas, Bersaing Ketat dengan Ganjar<br /><br /><br /></p>', '2023-05-27 03:57:43', 1, 7);
...
--
-- Struktur dari tabel `member_iccn`
--

CREATE TABLE `member_iccn` (
  `id_univ` int(11) NOT NULL,
  `nama_univ` varchar(50) NOT NULL,
  `link_univ` varchar(50) NOT NULL,
  `gambar_univ` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data untuk tabel `member_iccn`
--

INSERT INTO `member_iccn` (`id_univ`, `nama_univ`, `link_univ`, `gambar_univ`) VALUES
(1, 'Universitas Sriwijaya', 'https://unsri.ac.id/', '');
...
INSERT INTO `pendidikan` (`id_pendidikan`, `nama_sekolah`, `tahun_lulus`, `nama_gelar`) VALUES
(1, 'Institut Teknologi dan Bisnis PalComTech', '2022', 'S. Kom');
...
--
-- Struktur dari tabel `questionanswer`
--
...
--
-- Struktur dari tabel `sejarah_iccn`
--

CREATE TABLE `sejarah_iccn` (
  `id` int(11) NOT NULL,
  `judul` varchar(100) NOT NULL,
...
--
-- Dumping data untuk tabel `sejarah_iccn`
--

INSERT INTO `sejarah_iccn` (`id`, `judul`, `keterangan`, `gambar`) VALUES
(1, 'INDONESIA CAREER CENTER NETWORK, MENEPIS BATAS PRIMORDIALISME, MERAJUT SOLUSI PERMASALAHAN SDM NASIO', '<p>Saat ini di Indonesia telah tumbuh dan berkembang pusat-pusat karir yang berada di sebuah institusi perguruan tinggi. Meski jumlahnya masih relatif sedikit, perkembangan pusat karir tampak semakin lama semakin baik.</p>\r\n<p>Di antara pusat karir tersebut, ada yang sudah mapan, cukup mapan, baru berdiri, atau bahkan baru direncanakan akan berdiri. Berawal dari gagasan untuk saling berkomunikasi, menjalin silaturahmi, saling memberi, mendukung, berbagi dan menguatkan, hingga suatu saat dapat membuat agenda bersama yang lebih konkrit dalam skala nasional, maka beberapa pertemuan telah digelar sejak di ITB untuk pertama kalinya pada tanggal 12 Desember 2015 (diikuti oleh 10 pusat karir), di ITS tanggal 14 Januari 2016 (20 pusat karir), dan di IPB tanggal 21 Januari 2016 (31 pusat karir), jejaring ini lahir, dibentuk dan disepakati dengan nama Indonesia Career Center Network (ICCN).</p>\r\n<div class=\"blocks-preview-body-holder removable-parent order-handle\">\r\n<div id=\"vbid-337f4706-huqcwz5d\" class=\"preview-element blocks-preview-body magic-circle-holder text-element quick-text-style-menu allow-mobile-hide\" data-menu-name=\"BLOCKS_PREVIEW_BODY\">\r\n<p>Kehadiran jejaring ini menjadi wadah atau sarana berbagi pengetahuan, pengalaman, konsultasi dan mencari solusi permasalahan dalam mengelola pusat karir di perguruan tinggi. Dengan jejaring ini juga diharapkan adanya percepatan dalam peningkatan peran, layanan dan profesionalisme pengelolaan pusat karir yang disesuaikan dengan karakter perguruan tinggi masing-masing. Lebih dari itu, jejaring ini juga menjadi sebuah konsekuensi dan kebutuhan sekaligus harapan untuk dapat menjawab tantangan di masa depan yang dihadapi oleh pusat karir itu sendiri khususnya, dan SDM lulusan perguruan tinggi pada umumnya.</p>\r\n<p>Melalui jejaring ini diharapkan menjadi sarana bertemunya semua stakeholder yang berkaitan dengan SDM di Indonesia, baik dari unsur pemerintah di lintas kementerian, perguruan tinggi, perusahaan sebagai pengguna lulusan, berbagai asosiasi profesi, para mahasiswa dan alumni perguruan tinggi dan para pencari kerja itu sendiri. Tujuan akhirnya adalah peningkatan SDM di Indonesia.</p>\r\n<p>ICCN merupakan sebuah era baru dimana persaingan atau kompetisi antar-perguruan tinggi sudah selayaknya ditinggalkan, khususnya dalam lingkup peningkatan kualitas SDM/lulusannya. Upaya kerjasama dan saling menguatkan perlu dikedepankan untuk masa depan SDM Indonesia yang lebih baik dan berkualitas, menuju persaingan Masyarakat Ekonomi ASEAN (MEA).</p>\r\n</div>\r\n</div>', '222-sejarah.jpg');
...
--
-- Indeks untuk tabel `member_iccn`
--
ALTER TABLE `member_iccn`
...
--
-- Indeks untuk tabel `sejarah_iccn`
--
ALTER TABLE `sejarah_iccn`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `member_iccn`
--
ALTER TABLE `member_iccn`
...
--
-- AUTO_INCREMENT untuk tabel `sejarah_iccn`
--
ALTER TABLE `sejarah_iccn`
