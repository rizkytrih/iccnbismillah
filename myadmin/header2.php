...
<div class="main-menu">
	<header class="header">
		<a href="index.html" class="logo"><i class="ico ti-rocket"></i>ICCN</a>
	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				<li>
					<a class="" href="artikel.php"><i class="menu-icon ti-flag"></i><span>Artikel</span><span class=""></span></a>
					<!-- /.sub-menu js__content -->
				</li>
				<li>
