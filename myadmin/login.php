...
<div id="single-wrapper">
    <form action="cek_login.php" class="frm-single" method="POST">
        <div class="inside">
            ...
            <div class="frm-input"><input name="username" type="text" placeholder="Username" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
            <!-- /.frm-input -->
