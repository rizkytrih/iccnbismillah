...
<div class="main-content">
        ...
        <a href="tambah-artikel.php"><button type="button" class="btn btn-icon btn-icon-right btn-primary btn-sm waves-effect waves-light"><i class="ico fa fa-plus"></i>Tambah Data</button> <br><br></a>
            <div class="box-content">
                ...
                <table class="table">
                    ...
                    <tbody id="tableBody">
                        ...
                        if (!empty($search)) {
                            $query = "SELECT * FROM berita JOIN admin ON admin.id_admin = berita.id_admin WHERE judul LIKE '%$search%' AND id_kategori = 4 ORDER BY tgl_posting DESC";
                        } else {
                            $query = "SELECT * FROM berita JOIN admin ON admin.id_admin = berita.id_admin WHERE id_kategori = 4 ORDER BY tgl_posting DESC";
                        }
